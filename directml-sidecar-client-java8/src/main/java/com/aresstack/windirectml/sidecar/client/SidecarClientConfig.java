...
public final class SidecarClientConfig {
    ...
    public String getSidecarJarPath()           { return sidecarJarPath; }
    public void setSidecarJarPath(String v)     { this.sidecarJarPath = v; }

    public String getModelDirectory()           { return modelDirectory; }
    public void setModelDirectory(String v)     { this.modelDirectory = v; }

    public String getEmbedBackend()             { return embedBackend; }
    public void setEmbedBackend(String v)       { this.embedBackend = v; }

    public boolean isDirectmlDebug()            { return directmlDebug; }
    public void setDirectmlDebug(boolean v)     { this.directmlDebug = v; }

    public String getDirectmlDllOverride()      { return directmlDllOverride; }
    public void setDirectmlDllOverride(String v){ this.directmlDllOverride = v; }

    public long getRequestTimeoutMillis()       { return requestTimeoutMillis; }
    public void setRequestTimeoutMillis(long v) { this.requestTimeoutMillis = v; }
    ...
    public void setExtraJvmArgs(String v)       { this.extraJvmArgs = v; }
}
