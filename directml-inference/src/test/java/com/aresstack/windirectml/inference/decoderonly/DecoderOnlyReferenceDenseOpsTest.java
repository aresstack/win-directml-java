...
class DecoderOnlyReferenceDenseOpsTest {
    ...
    void dotMatchesScalarReference() {
        ...
        float result = DecoderOnlyReferenceDenseOps.dot(left, 1, right, 1, 8);
    ...
    void multiplyRowsMatchesScalarReference() {
        ...
        DecoderOnlyReferenceDenseOps.multiplyRows(matrix, 2, 3, input, output);
