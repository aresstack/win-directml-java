 ...
 *
 * <p>This is the Phi-3-package copy of the same class that lives in
 * {@code inference.qwen}. Both classes are package-private and identical
 * except for the package declaration.
 */
final class SimdOps {
