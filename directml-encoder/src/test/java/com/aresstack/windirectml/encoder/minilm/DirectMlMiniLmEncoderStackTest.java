    ...
    void multiLayerMatchesCpuReference() throws DirectMlRuntimeException {
        ...
        try {
            ...
            for (int l = 0; l < LAYERS; l++) {
                qw[l] = rand(rng, HIDDEN * HIDDEN, 0.05f);
                qb[l] = zeros(HIDDEN);
                kw[l] = rand(rng, HIDDEN * HIDDEN, 0.05f);
                kb[l] = zeros(HIDDEN);
                vw[l] = rand(rng, HIDDEN * HIDDEN, 0.05f);
                vb[l] = zeros(HIDDEN);
                ow[l] = rand(rng, HIDDEN * HIDDEN, 0.05f);
                ob[l] = zeros(HIDDEN);
                ag[l] = ones(HIDDEN);
                ab[l] = zeros(HIDDEN);
                iw[l] = rand(rng, INTER * HIDDEN, 0.05f);
                ib[l] = zeros(INTER);
                mw[l] = rand(rng, HIDDEN * INTER, 0.05f);
                mb[l] = zeros(HIDDEN);
                og[l] = ones(HIDDEN);
                ob2[l] = zeros(HIDDEN);
            ...
            try (GpuBuffer xInBuf = ctx.allocateBufferFor(xInitCpu, GpuBuffer.BufferUsage.ACTIVATION);
                ...
                ownedWeights.add(embGammaB);
                ownedWeights.add(embBetaB);
                ...
                for (int l = 0; l < LAYERS; l++) {
                    ...
                    ownedWeights.add(qwB);
                    ownedWeights.add(qbB);
                    ownedWeights.add(kwB);
                    ownedWeights.add(kbB);
                    ownedWeights.add(vwB);
                    ownedWeights.add(vbB);
                    ownedWeights.add(owB);
                    ownedWeights.add(obB);
                    ownedWeights.add(agB);
                    ownedWeights.add(abB);
                    ownedWeights.add(iwB);
                    ownedWeights.add(ibB);
                    ownedWeights.add(mwB);
                    ownedWeights.add(mbB);
                    ownedWeights.add(ogB);
                    ownedWeights.add(ob2B);
