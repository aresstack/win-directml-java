 ...
 *   <li>{@code auto} (default) – try DirectML first, silently fall back
 *       to CPU on failure. Missing model directory is non-fatal: the
 *       {@code rerank} handler stays in {@code not-implemented} mode.</li>
 * </ul>
